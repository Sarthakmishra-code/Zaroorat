  ...
  return (
    ...
    >
      ...
      <div className="relative h-48 mb-4 rounded-xl overflow-hidden bg-gray-100 dark:bg-dark-700">
        <img
          src={car.images?.[0]?.url || 'https://images.unsplash.com/photo-1583121274602-3e2820c69888?w=400&h=300&fit=crop'}
          alt={car.name}
          className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300"
          onError={(e) => { e.target.src = 'https://images.unsplash.com/photo-1583121274602-3e2820c69888?w=400&h=300&fit=crop'; }}
        />
        {car.availability ? (
      ...
      <div>
        ...
        <div className="flex items-center gap-4 mb-4 text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="flex items-center gap-1">
            ...
            <span>4.7 <span className="text-gray-400 text-xs">(84 reviews)</span></span>
          </div>
        </div>
